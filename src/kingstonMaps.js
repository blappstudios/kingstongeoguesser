/**
 * Kingston Google Maps Embed for GeoGuesser
 * Uses a proper Google Maps embed URL that actually works
 */

export const KingstonMaps = {
  container: null,
  iframe: null,
  onMapClick: null,
  
  /**
   * Initialize Kingston Google Maps embed
   */
  init(container, onMapClick) {
    ...
    console.log('🗺️ Kingston Google Maps embed initialized');
  },
