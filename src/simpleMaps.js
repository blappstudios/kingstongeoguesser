/**
 * Simple Google Maps Embed for Kingston GeoGuesser
 * Uses basic Google Maps embed without API key restrictions
 */
...
export const SimpleMaps = {
  ...
  /**
   * Initialize simple Google Maps embed
   */
  init(container, onMapClick) {
    ...
    // Use a proper Google Maps embed URL for Kingston
    ...
    console.log('🗺️ Simple Google Maps embed initialized');
  },
